    ...
    const fetchData = async () => {
      try {
        const [trendingRes, upcomingRes] = await Promise.all([
          api.get('/jogos/trending'),
          api.get('/jogos/upcoming')
        ]);
    ...
    <div className="container mx-auto px-6 py-8 max-w-screen-xl">
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-gray-400 mb-6">Partidas recentes bem avaliadas pela comunidade.</p>
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="bg-[#133B5C]/70 rounded-xl border border-gray-700 p-8 text-center text-gray-400">
                <p>O feed de atividades dos usuários que você segue aparecerá aqui.</p>
                <p className="text-sm">(Funcionalidade a ser implementada na Etapa 5)</p>
              </div>
            </section>
          </div>
