...
export default function Header() {
  ...
  // Lógica de seleção da imagem de perfil atualizada
  const profilePicUrl = user?.foto_perfil
    ? `${process.env.NEXT_PUBLIC_API_URL}${user.foto_perfil}` // Se o usuário tem foto, usa a do backend
    : '/placeholder.png';  // Caso contrário, usa o placeholder local
